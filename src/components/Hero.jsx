export default function Hero({ content, isDark }) {
  ...
  return (
    <section className="mx-auto flex min-h-[calc(100vh-74px)] max-w-6xl items-center px-5 py-20">
...
function InfoBox({ label, value, isDark }) {
  return (
    ...
    >
      ...
      <p className={isDark ? "mt-1 font-semibold text-white" : "mt-1 font-semibold text-slate-950"}>
        {value}
      </p>
    </div>
  );
